  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -right-1/4 w-[150%] h-[200%] bg-gradient-to-br from-primary/5 via-transparent to-transparent rotate-12 transform-gpu" />
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Button 
                size="lg" 
                className="group text-lg px-8 py-6 bg-primary hover:bg-primary/90 text-primary-foreground rounded-none"
